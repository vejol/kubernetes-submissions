...
The application's configuration and manifests are stored in a separate repository: https://github.com/vejol/project-config. Initial deployment steps can also be found there.
